...
const Navbar = () => {
   ...
   const handelclick = () =>{
    ...
    return (
        <div className="navbar bg-base-100 dark:text-white sticky inset-0 z-10  rounded-none border  bg-opacity-30  text-black shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-2 md:py-4 max-[769px]:py-9">
        ...
        <div className="dropdown md:px-12">
          ...
          <ul
            ...
            <div className='md:flex flex-col justify-center items-center max-[320px]:hidden'>
                <img className="xl:w-[100px] w-[80px]"  src={logo} />
                <h1 className='xl:text-2xl font-extrabold max-[426px]:text-sm'>LibraWiseReads</h1>
            </div>
      </div>
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal  xl:text-xl font-bold flex items-center gap-5 px-1">
        <NavLink
            to={"/"}
            className={({ isActive, isPending }) =>
            isActive
            ...
            <label onChange={handelclick} className="swap swap-rotate">
